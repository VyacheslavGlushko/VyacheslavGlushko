...
* [**SQL-запросы для валидации данных**](https://github.com/VyacheslavGlushko/SQL-academy)
...
* [**Git: освоенные команды и практики**](https://github.com/VyacheslavGlushko/GIT)
    * **Описание:** Ключевые команды и аспекты работы с Git     
